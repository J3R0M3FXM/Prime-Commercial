    ...
    <div className="space-y-6">
      ...
      <div className="p-4 bg-slate-50 border border-dashed border-slate-300 rounded-xl flex items-center justify-between text-xs text-slate-500 font-sans">
        <div className="flex items-center gap-2">
          ...
          <span>Extensible Diagnostic Registry — additional services (SMS gateway, Webhooks, AI Logic) will integrate here automatically.</span>
        </div>
        <span className="font-mono text-[10px] text-slate-400 uppercase font-bold tracking-wider">v2.0 Diagnostics</span>
      </div>
    </div>
  );
}
